...
public partial class AdminDeleteSP : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        string cmdstr = "select * from sp_registration where status=1";
    ...
    protected void DataList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ob1.exec("update sp_registration set status=2 where aid=" + s + "");
        ob1.exec("update Login set status=0 where userid=" + s + "");
        BindData();
    }
}