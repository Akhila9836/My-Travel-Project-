...
public partial class AgentRegistration : System.Web.UI.Page
{
    ...
    {
        int c = 0;
        ob.dr = ob.ret_dr("select isnull(max(aid),200)+1 from sp_registration");
        if (ob.dr.Read())
        {
    ...
    {
        if (TextBox1.Text == "" || TextBox2.Text == "" || TextBox3.Text == "" || TextBox4.Text == "" || TextBox5.Text == "" || TextBox6.Text == "" || TextBox8.Text == "" || TextBox9.Text == ""  || TextBox10.Text == "")
        {
        ...
        else
        {
            ...
            if (!ob.dr.Read())
            {
                ...
                string str = "insert into sp_registration values(" + uid + ",'" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox7.Text + "','" + TextBox3.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + TextBox8.Text + "','" + TextBox9.Text + "','" + TextBox11.Text + "','" + TextBox10.Text + "',0)";
                ob.exec(str);
