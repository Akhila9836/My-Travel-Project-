<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage.master" AutoEventWireup="true" CodeFile="UserBookProduct.aspx.cs" Inherits="UserBookProduct" %>
...
<script type="text/javascript">
    ...
    <asp:DataList ID="DataList2" runat="server" BackColor="White" BorderColor="Fuchsia"
        ...
        <div style="Width:100%;float:right;text-align:left;margin-left:40px;">
...
<br />   
                ...
                Font-Size = "Small"></asp:Label> <br /> <asp:TextBox ID="TextBox8" runat="server" Width="900px" Height="200px" TextMode="MultiLine" ></asp:TextBox> 
                               ...
                               <br />
<br />   
                             <asp:Label ID="Label9" runat="server" Text="Tour Plan:" Font-Bold="True" 
                Font-Size = "Small"></asp:Label> <br /> <asp:TextBox ID="TextBox12" runat="server" Width="900px" Height="200px" TextMode="MultiLine" ></asp:TextBox> 

                               <br />
<br />   
                 <asp:Label ID="Label5" runat="server" Text="No of Person:" Font-Bold="True" 
                Font-Size = "Small"></asp:Label> &nbsp; &nbsp;<asp:TextBox ID="TextBox5" runat="server" Width="100px" Height="30px" ></asp:TextBox> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label19" runat="server" Text="Select No of Person:" Font-Bold="True" 
Font-Size = "Small"></asp:Label>&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="DropDownList1" 
         runat="server" Width="150px" Height="30px" AutoPostBack="True" 
         onselectedindexchanged="DropDownList1_SelectedIndexChanged" >
 </asp:DropDownList> 
                            <br />
                 <br />   
                 <asp:Label ID="Label27" runat="server" Text="Accomadation:" Font-Bold="True" 
                Font-Size = "Small"></asp:Label> <asp:TextBox ID="TextBox2" runat="server" Width="100px" Height="30px" ></asp:TextBox> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label28" runat="server" Text="Select Room:" Font-Bold="True" 
Font-Size = "Small"></asp:Label>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="DropDownList2" 
         runat="server" Width="150px" Height="30px" AutoPostBack="True" 
         onselectedindexchanged="DropDownList2_SelectedIndexChanged" >
                ...
                Font-Size = "Small"></asp:Label> &nbsp; &nbsp;&nbsp; &nbsp; <asp:TextBox ID="TextBox4" runat="server" Width="100px" Height="30px" ></asp:TextBox> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label32" runat="server" Text="Select Food Type:" Font-Bold="True" 
Font-Size = "Small"></asp:Label>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<asp:DropDownList ID="DropDownList4" 
         runat="server" Width="150px" Height="30px" AutoPostBack="True" 
...
<br />   
                ...
                Font-Size = "Small"></asp:Label>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; <asp:TextBox ID="TextBox3" runat="server" Width="100px" Height="30px" ></asp:TextBox> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label30" runat="server" Text="Select Vehicle:" Font-Bold="True" 
Font-Size = "Small"></asp:Label>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;<asp:DropDownList ID="DropDownList3" 
         runat="server" Width="150px" Height="30px" AutoPostBack="True" 
...
<br />                 
&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;  &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;<asp:Button 
             ID="Button1" runat="server" Height="40px" Text="Calculate" class="btn  btn-primary"   onclick="Button1_Click"  
    Width="200px"/>
   
            <br /> 
         <br /> 
                             <asp:Label ID="Label6" runat="server" Text="Total Price :" Font-Bold="True" 
                Font-Size = "Small"></asp:Label>&nbsp; &nbsp;&nbsp; <asp:TextBox ID="TextBox9" runat="server" Width="200px" Height="30px" ></asp:TextBox> &nbsp;&nbsp;&nbsp;

   <br /> 
<br />     
                                         <asp:Label ID="Label7" runat="server" Text="Tour Date :" Font-Bold="True" 
                Font-Size = "Small"></asp:Label>&nbsp; &nbsp;&nbsp; &nbsp; <asp:TextBox ID="TextBox10" runat="server" Width="200px" Height="30px" TextMode="Date" ></asp:TextBox> &nbsp;&nbsp;&nbsp;

   <br /> 
<br />    
                                                     <asp:Label ID="Label8" runat="server" Text="Booking Date :" Font-Bold="True" 
                Font-Size = "Small"></asp:Label> <asp:TextBox ID="TextBox11" runat="server" Width="200px" Height="30px" ></asp:TextBox> &nbsp;&nbsp;&nbsp;

   <br /> 
<br />     
&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;  &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;<asp:Button 
             ID="Button2" runat="server" Height="40px" Text="Book Now" class="btn  btn-primary"   onclick="Button2_Click"  
    Width="200px"/>
