<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage.master" AutoEventWireup="true" CodeFile="UserCancelBooking.aspx.cs" Inherits="UserCancelBooking" %>
        ...
        <div style="Width:100%;float:right;text-align:left;margin-left:40px; font-weight: 700;">
             ...
             <asp:Label ID="Label1" runat="server" Text="Package Name:" Font-Bold="True"  Font-Size = "Small"></asp:Label>
               ...
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label3" runat="server" Text="Location:" Font-Bold="True"  
                ...
                Font-Size = "Small"></asp:Label> <br /> <asp:TextBox ID="TextBox1" runat="server" Width="900px" Height="70px" TextMode="MultiLine" Enabled="False" ></asp:TextBox> 

                               <br />
<br />   
                 <asp:Label ID="Label33" runat="server" Text="About Package:" Font-Bold="True" 
                Font-Size = "Small"></asp:Label> <br /> <asp:TextBox ID="TextBox6" runat="server" Width="900px" Height="100px" TextMode="MultiLine" Enabled="False" ></asp:TextBox> 

                               <br />
<br />   
                        
                 <asp:Label ID="Label34" runat="server" Text="Inclusion:" Font-Bold="True" 
                Font-Size = "Small"></asp:Label> <br /> <asp:TextBox ID="TextBox7" runat="server" Width="900px" Height="200px" TextMode="MultiLine" Enabled="False" ></asp:TextBox> 

                               <br />
<br />   
                        
                 <asp:Label ID="Label35" runat="server" Text="Exclusion:" Font-Bold="True" 
                Font-Size = "Small"></asp:Label> <br /> <asp:TextBox ID="TextBox8" runat="server" Width="900px" Height="200px" TextMode="MultiLine" Enabled="False" ></asp:TextBox> 

                               <br />
<br />   
                 <asp:Label ID="Label5" runat="server" Text="No of Person:" Font-Bold="True" 
                Font-Size = "Small"></asp:Label> &nbsp; &nbsp;<asp:TextBox ID="TextBox5" runat="server" Width="200px" Height="30px" Enabled="False" ></asp:TextBox> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label19" runat="server" Text="Total Price:" Font-Bold="True" 
Font-Size = "Small"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox12" runat="server" Width="200px" Height="30px" Enabled="False" ></asp:TextBox>  
                            <br />
                 <br />   
                 <asp:Label ID="Label27" runat="server" Text="Accomadation:" Font-Bold="True" 
                Font-Size = "Small"></asp:Label> <asp:TextBox ID="TextBox2" runat="server" Width="200px" Height="30px" Enabled="False" ></asp:TextBox> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label28" runat="server" Text="Tour Date:" Font-Bold="True" 
Font-Size = "Small"></asp:Label>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox13" runat="server" Width="200px" Height="30px" Enabled="False" ></asp:TextBox> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<br />
                 <br />   
                            
                 <asp:Label ID="Label31" runat="server" Text="Food Type:" Font-Bold="True" 
                Font-Size = "Small"></asp:Label> &nbsp; &nbsp;&nbsp; &nbsp; <asp:TextBox ID="TextBox4" runat="server" Width="200px" Height="30px" Enabled="False" ></asp:TextBox> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label32" runat="server" Text="Booking Date:" Font-Bold="True" 
Font-Size = "Small"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox14" runat="server" Width="200px" Height="30px" Enabled="False" ></asp:TextBox> &nbsp; &nbsp;&nbsp; &nbsp;<br />
<br />   
                 <asp:Label ID="Label29" runat="server" Text="Travel :" Font-Bold="True" 
                Font-Size = "Small"></asp:Label>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; <asp:TextBox ID="TextBox3" runat="server" Width="200px" Height="30px" Enabled="False" ></asp:TextBox> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label30" runat="server" Text="Reference Code:" Font-Bold="True" 
Font-Size = "Small"></asp:Label>&nbsp;<asp:TextBox ID="TextBox15" runat="server" Width="200px" Height="30px" Enabled="False" ></asp:TextBox> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;<br /> 
<br />     
                                         <asp:Label ID="Label7" runat="server" Text="Paid Amount :" Font-Bold="True" 
                Font-Size = "Small"></asp:Label>&nbsp;   <asp:TextBox ID="TextBox10" runat="server" Width="200px" Height="30px" TextMode="Number" Enabled="False" ></asp:TextBox> &nbsp;&nbsp;&nbsp;

                                         <asp:Label ID="Label36" runat="server" Text="Balance Amount" Font-Bold="True" 
                Font-Size = "Small"></asp:Label>&nbsp; &nbsp;&nbsp; <asp:TextBox ID="TextBox16" runat="server" Width="200px" Height="30px" Enabled="False" ></asp:TextBox> 

   <br /> 
<br />    
                                                     <asp:Label ID="Label8" runat="server" Text="Paid Date:" Font-Bold="True" 
                Font-Size = "Small"></asp:Label>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;  <asp:TextBox ID="TextBox11" runat="server" Width="200px" Height="30px" Enabled="False" ></asp:TextBox> &nbsp;&nbsp;&nbsp;
...
&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;  &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;<br /> 
         <br /> 
   &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;  &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;<asp:Button 
             ID="Button2" runat="server" Height="40px" Text="Cancel Booking" class="btn  btn-primary"   onclick="Button2_Click"  
    Width="200px"/>
