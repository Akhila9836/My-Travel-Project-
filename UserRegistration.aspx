		...
		<div class="card borderless">
			<div class="row align-items-center text-center">
				<div class="col-md-12">
					<div class="card-body">
						...
						<h4 class="f-w-400">User Registration</h4>
						<hr>
                 ...
                 ErrorMessage="*" ForeColor="#FF5050" ControlToValidate="TextBox1"></asp:RegularExpressionValidator>--%>
						...
						<div class="form-group mb-3">
							<asp:TextBox ID="TextBox2" runat="server" Width="300px" Height="40px"  placeholder="Name" ></asp:TextBox> 
           ...
           ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
						...
						<asp:TextBox ID="TextBox6" runat="server"  Width="300px" Height="40px"  placeholder=" Contact"  MaxLength="10" onkeypress="if(event.keyCode<48 || event.keyCode>57)event.returnValue=false;" ></asp:TextBox> 
							 		...
							 		<div class="form-group mb-4"> 
										 <asp:DropDownList ID="DropDownList6" runat="server" Width="300px" Height="40px"  ></asp:DropDownList>
         <br />
						 </div> 
							 		<div class="form-group mb-4">
							<asp:TextBox ID="TextBox8" runat="server" Width="300px" Height="40px"  placeholder="DOB" TextMode="Date" ></asp:TextBox> 
							 </div> 
							 		<div class="form-group mb-4">
							<asp:TextBox ID="TextBox9" runat="server" Width="300px" Height="40px"  placeholder="Aadhaar"  MaxLength="12" onkeypress="if(event.keyCode<48 || event.keyCode>57)event.returnValue=false;"></asp:TextBox> 
							 </div> 
							 			 		<div class="form-group mb-4">
