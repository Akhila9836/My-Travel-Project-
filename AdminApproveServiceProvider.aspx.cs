...
public partial class AdminApproveServiceProvider : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        string cmdstr = "select * from sp_registration where status=0";
    ...
    protected void DataList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ob1.exec("update sp_registration set status=1 where aid=" + s + "");
        ob1.exec("update Login set status=2 where userid=" + s + "");
        BindData();
    }
}