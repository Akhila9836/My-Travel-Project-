<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VistorSPList.aspx.cs" Inherits="VistorSPList" %>
        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav ml-auto py-0">
                    ...
                    <a href="UserRegistration.aspx" class="nav-item nav-link">User Registration</a>
                    <a href="AgentRegistration.aspx" class="nav-item nav-link">Agent Registration</a>
...
<asp:GridView ID="gvProviders" runat="server" AutoGenerateColumns="False" CssClass="table" Style="margin-left: 100px;">
    <Columns>
