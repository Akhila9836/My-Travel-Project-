          ...
          <div class="row">
              ...
              <div class="col-lg-6 pt-5 pb-lg-5">
                  <div class="about-text bg-white p-4 p-lg-5 my-lg-5">
                      ...
                      <p>The development of a comprehensive travel package website aims to provide an integrated platform for users to plan and book their travel needs conveniently. The website will be designed with a modern user interface (UI) and optimized user experience to ensure seamless navigation</p>
                      <div class="row mb-4">
                          <div class="col-6">
              ...
              <div class="col-md-4">
                  <div class="d-flex mb-4 mb-lg-0">
                      ...
                      <div class="d-flex flex-column">
                          ...
                          <p class="m-0">Find affordable vacation packages for top tourist destinations at cheap price and book online</p>
                      </div>
                  </div>
              </div>
              <div class="col-md-4">
                  <div class="d-flex mb-4 mb-lg-0">
                      ...
                      <div class="d-flex flex-column">
                          ...
                          <p class="m-0">Redefine love and keep your loved one closer in the most magical places that spell romance.</p>
                      </div>
                  </div>
              </div>
              <div class="col-md-4">
                  <div class="d-flex mb-4 mb-lg-0">
                      ...
                      <div class="d-flex flex-column">
                          ...
                          <p class="m-0">Give yourself a break from the monotonous life, explore the breath-taking beauty through Us.</p>
                      </div>
                  </div>
              </div>
          </div>
