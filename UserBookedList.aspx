<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage.master" AutoEventWireup="true" CodeFile="UserBookedList.aspx.cs" Inherits="UserBookedList" %>
        ...
        <div style="Width:100%;float:right;text-align:left;margin-left:40px; font-weight: 700;">
             ...
             <asp:Label ID="Label1" runat="server" Text="Package Name:" Font-Bold="True"  Font-Size = "Small"></asp:Label>
               ...
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label3" runat="server" Text="Location:" Font-Bold="True"  
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Label ID="Label37" runat="server" Text="Emergency Contact:" Font-Bold="True"  
                Font-Size = "Small" ForeColor="Black"></asp:Label> 
             <asp:Label ID="lblContact" runat="server" Font-Bold="False" ForeColor="Black" Font-Size = "Small"></asp:Label>   
                <br />
                 <br />   
...
<br />   
                ...
                Font-Size = "Small"></asp:Label> <br /> <asp:TextBox ID="TextBox8" runat="server" Width="900px" Height="200px" TextMode="MultiLine" ></asp:TextBox> 
                               ...
                               <br />
<br />   
                             <asp:Label ID="Label6" runat="server" Text="Tour Plan:" Font-Bold="True" 
                Font-Size = "Small"></asp:Label> <br /> <asp:TextBox ID="TextBox9" runat="server" Width="900px" Height="200px" TextMode="MultiLine" ></asp:TextBox> 
...
<br />  
            &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;  &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;<asp:Button 
             ID="Button1" runat="server" Height="40px" Text="Generate Report" class="btn  btn-primary"   onclick="Button1_Click"  
    Width="200px"/>
